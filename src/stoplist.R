...
stoplist <- c(
    ...
    "kmcudaR" = "--install=fake",
    "permGPU" = "--install=fake",
    ...
    "caRpools" = no_run_time_checks_args,
    ...
    "IRATER" = no_run_time_checks_args,
    ## Package localsolver needs localsolver.
    "localsolver" = no_run_time_checks_args,
    ...
    ## Goslate keeps getting HTTP Error 503: Service Unavailable. on 2016-04-07
    ...
    ## Package TSjson keeps hanging. on 2015-02-01.
    ...
    ## access to http://celsius.genomics.ctrl.ucla.edu. on 2010-07-30.
    ...
    "TrajDataMining" = "--no-tests",
    "TropFishR" = "--no-vignettes",
    ...
    "ifaTools" = "--no-tests --no-vignettes",
    "ivmte" = "--no-vignettes",
    "knockoff" = "--no-vignettes",
    "laGP" = "--no-vignettes",
    "lolog" = "--no-vignettes",
    "mazeinda" = "--no-vignettes",
    "mcemGLM" = "--no-vignettes",
    ## set_check_args mediation		"--no-vignettes"
    ## Re-activated 2021-10-18:
    ##   set_check_args micEconCES		"--no-vignettes"
    "misreport" = "--no-vignettes",
    ## Re-activated 2021-10-18:
    ##   set_check_args morse		"--no-vignettes"
    "onemap" = "--no-vignettes",
    "optimall" = "--no-vignettes",
